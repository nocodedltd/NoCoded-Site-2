...
export default function ImpactCalculator() {
  ...
  const modes = [
    { 
      ...
      activeColor: 'from-accent-blue to-cyan-500'
    },
    { 
      id: 'cost', 
      label: 'Cost Saved', 
      ...
      activeColor: 'from-accent-purple to-pink-500'
    },
    { 
      id: 'efficiency', 
      ...
      activeColor: 'from-accent-blue to-accent-purple'
    }
  ];
  ...
  const checkAchievements = (newResults: any) => {
    ...
    // Time achievements
    if (newResults.timeSaved >= 2000) {
      newAchievements.push('⏰ Time Master');
    } else if (newResults.timeSaved >= 1000) {
      newAchievements.push('⏰ Time Saver');
    } else if (newResults.timeSaved >= 500) {
      newAchievements.push('⏰ Time Starter');
    }
    
    // Cost achievements
    if (newResults.costSaved >= 100000) {
      newAchievements.push('💰 Money Master');
    } else if (newResults.costSaved >= 50000) {
      newAchievements.push('💰 Money Saver');
    } else if (newResults.costSaved >= 25000) {
      newAchievements.push('💰 Money Starter');
    }
    
    // Efficiency achievements
    if (newResults.efficiencyGain >= 80) {
      newAchievements.push('⚡ Efficiency Master');
    } else if (newResults.efficiencyGain >= 60) {
      newAchievements.push('⚡ Efficiency Pro');
    } else if (newResults.efficiencyGain >= 40) {
  ...
  const getProgressPercentage = (value: number, mode: string) => {
    const thresholds = { time: 2000, cost: 100000, efficiency: 80 };
    const maxValue = thresholds[mode as keyof typeof thresholds];
  ...
  const Confetti = () => (
    <div className="fixed inset-0 pointer-events-none z-50">
      {[...Array(50)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-2 h-2 bg-gradient-to-r from-accent-blue to-accent-purple rounded-full"
          initial={{
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary">
              Your Time & Money, Reclaimed
            </h2>
          </div>
          <p className="text-lg text-primary/90 max-w-3xl mx-auto">
            Discover how much time and cost you could save by automating the boring stuff. 
            In just seconds, see your potential gains then let's make them happen.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-background/50 backdrop-blur-sm p-2 rounded-xl border border-accent-blue/20 shadow-lg">
            {modes.map((mode) => (
              <button
                key={mode.id}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <motion.div
            ...
            className="bg-background/50 backdrop-blur-sm p-8 rounded-2xl border border-accent-blue/20 shadow-2xl text-center"
          >
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-background border border-accent-blue/20 rounded-lg text-primary focus:ring-2 focus:ring-accent-blue focus:border-transparent text-center"
                      min="1"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full"
                    />
                    <div className="flex justify-between text-sm text-primary/70 mt-1">
                      <span>10%</span>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {activeMode === 'time' && (
                ...
                >
                  <div className="mb-6">
                    <Clock className="h-16 w-16 text-accent-blue mx-auto mb-4" />
                    <motion.div 
                      key={results.timeSaved}
                      initial={{ opacity: 0, scale: 0.8 }}
                      animate={{ opacity: 1, scale: 1 }}
                      transition={{ duration: 0.3 }}
                      className="text-4xl font-bold text-accent-blue mb-2"
                    >
                      {formatTime(results.timeSaved)}
                    </motion.div>
                    <p className="text-primary/80">saved annually</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-accent-blue/10 to-accent-purple/10 p-4 rounded-lg">
                    <p className="text-sm text-primary/80">
                      That's equivalent to <span className="text-accent-blue font-semibold">
                ...
                >
                  <div className="mb-6">
                    ...
                    <motion.div 
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      transition={{ duration: 0.3 }}
                      className="text-4xl font-bold text-accent-purple mb-2"
                    >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-background rounded-full h-2">
                      <motion.div
                        className="bg-gradient-to-r from-accent-purple to-pink-500 h-2 rounded-full"
                        initial={{ width: 0 }}
                  ...
                  <div className="bg-gradient-to-r from-accent-purple/10 to-pink-500/10 p-4 rounded-lg">
                    <p className="text-sm text-primary/80">
                      That's <span className="text-accent-purple font-semibold">
              ...
              {activeMode === 'efficiency' && (
                ...
                >
                  <div className="mb-6">
                    <TrendingUp className="h-16 w-16 text-accent-blue mx-auto mb-4" />
                    <motion.div 
                    ...
                    <p className="text-primary/80">efficiency improvement</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-accent-blue/10 to-accent-purple/10 p-4 rounded-lg">
                    <p className="text-sm text-primary/80">
                      Tasks now take <span className="text-accent-blue font-semibold">
            ...
            {achievements.length > 0 && (
              <motion.div
                ...
                className="mt-6 p-4 bg-gradient-to-r from-accent-blue/10 to-accent-purple/10 rounded-lg border border-accent-blue/20"
              >
                <div className="flex items-center justify-center gap-2 mb-2">
                  <Trophy className="h-5 w-5 text-accent-blue" />
                  <span className="text-sm font-medium text-accent-blue">Achievements Unlocked!</span>
                </div>
                <div className="flex flex-wrap justify-center gap-2">
                  {achievements.map((achievement, index) => (
                    <motion.span
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1 bg-accent-blue/20 text-accent-blue text-xs rounded-full"
                    >
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.4 }}
              className="mt-6 pt-4 border-t border-accent-blue/10"
            >
            ...
            <motion.div
              ...
              className="mt-6 pt-6 border-t border-accent-blue/20"
            >
              <div className="flex items-center justify-center gap-2 mb-4">
                <Sparkles className="h-5 w-5 text-accent-blue" />
                <p className="text-sm text-primary/80">Want a detailed breakdown?</p>
              </div>
              <Link
                to="/contact"
